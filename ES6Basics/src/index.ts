...
import * as Splice_SliceLib from "./scripts/SpliceVSSlice";
...
console.log(
  "(@_@) ---- arrow function Logic Example Start From Here ---- (@_@)"
);
console.log(
  "Normal Arrow Function Demo Result : ",
  ArrowFunctionLib.additionArrowFunction(20, 30)
);
console.log(
  "Inline Arrow Function Demo Result : ",
  ArrowFunctionLib.addArrowInlineFunctio(20, 30)
);
...
console.log(
  "(@_@) ---- Default Parameter Logic Example Start From Here ---- (@_@)"
);
...
console.log(
  "(@_@) ---- Spread & Rest Operator Logic Example Start From Here ---- (@_@)"
);
...
console.log(
  "(@_@) ---- Spread & Rest Operator Logic Example End Here ---- (@_@)"
);

/** Destructing Assignment Logic Example */
console.log(
  "(@_@) ---- Destructing Assignment Logic Example Start From Here ---- (@_@)"
);
DestructingAssignmentLib.arrayDestructingResult();
DestructingAssignmentLib.objectDestructingResult();
console.log(
  "(@_@) ---- Destructing Assignment Logic Example End Here ---- (@_@)"
);

/** Destructing Assignment Logic Example */
console.log(
  "(@_@) ---- Splice() & Slice() Logic Example Start From Here ---- (@_@)"
);
Splice_SliceLib.spliceMethodDemo();
Splice_SliceLib.sliceMethodDemo();
console.log(
  "(@_@) ---- Splice() & Slice() Logic Example End Here ---- (@_@)"
);
